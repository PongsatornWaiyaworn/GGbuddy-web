      ...
      <div className="flex flex-1 w-full">
        ...
        <main className="flex-1 p-6 md:p-12 max-w-3xl mx-auto">
          ...
          <p className="text-gray-300 text-center mb-10 text-base md:text-lg leading-relaxed">
            เราคือนักพัฒนารุ่นใหม่ที่มุ่งมั่นสร้างประสบการณ์เกมที่เชื่อมโยงผู้เล่นเข้าด้วยกันผ่าน GGbuddy  
            เพราะเราเชื่อว่าเกมที่ดี ไม่ได้ให้แค่ความสนุก แต่มันสามารถสร้างมิตรภาพ และเปลี่ยนแปลงความสัมพันธ์ระหว่างผู้คนได้
          </p>
